...
def analyze(request):
    getData = request.GET.get('text', 'default')

    removepunc = request.GET.get('removepunc', 'off')
    capitalization = request.GET.get('capitalization', 'off')
    ...
    if removepunc == 'on':
        ...
        analyzed = ""
        for index, char in enumerate(getData):
            if not (getData[index] == " " and getData[index + 1] == " "):
                analyzed = analyzed + char
    ...
    #
    #     params = {'purpose': 'Total Length', 'analyzed_text': analyzed}
    #     return render(request, 'analyze.html', params)
